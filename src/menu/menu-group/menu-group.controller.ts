...
export class MenuGroupController {
  ...
  async create(
    @Payload() createMenuGroupDto: CreateMenuGroupDto,
  ...
  async findAll(
    @Payload() fetchMenuGroupDto: FetchMenuGroupOfMenuDto,
  ...
  async update(
    @Payload() updateMenuGroupDto: UpdateMenuGroupDto,
  ...
  async delete(
    @Payload() deleteMenuGroupDto: DeleteMenuGroupDto,
