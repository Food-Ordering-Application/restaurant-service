...
import {
  ...
  IFetchToppingGroupOfMenuResponse,
...
export class ToppingGroupController {
  ...
  async create(
    @Payload() createToppingGroupDto: CreateToppingGroupDto,
  ...
  async findAll(
    @Payload() fetchToppingGroupDto: FetchToppingGroupOfMenuDto,
  ...
  async update(
    @Payload() updateToppingGroupDto: UpdateToppingGroupDto,
  ...
  async delete(
    @Payload() deleteToppingGroupDto: DeleteToppingGroupDto,
